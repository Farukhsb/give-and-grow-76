  ...
  <Layout>
    <div className="container py-16">
      ...
      <div className="mt-8 max-w-3xl space-y-6 text-sm leading-relaxed text-muted-foreground">
        ...
        <section><h2 className="mb-2 font-serif text-xl font-semibold text-foreground">Donations</h2><p>All donations made through CharityApp are voluntary and non-refundable unless otherwise stated in our Donation Policy. We act as an intermediary and ensure funds are directed to the intended charity.</p></section>
