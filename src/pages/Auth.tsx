        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-md">
          <Card className="border-0 shadow-xl">
            <CardHeader className="text-center pb-2">
              ...
              <CardTitle className="font-serif text-2xl">{isLogin ? "Welcome Back" : "Join CharityApp"}</CardTitle>
              <CardDescription>{isLogin ? "Sign in to continue making a difference" : "Create an account and start your giving journey"}</CardDescription>
            </CardHeader>
            <CardContent>
              {/* Google Sign In */}
