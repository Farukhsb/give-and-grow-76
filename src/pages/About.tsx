      ...
      <div className="container">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { icon: <Award className="h-8 w-8 text-secondary" />, title: "Verified Payments", desc: "Donations are confirmed server-side after the payment provider reports a successful checkout." },
